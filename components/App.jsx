...
function CarView({ onZoneClick, selectedZone, hoveredZone: externalHover }) {
  ...
  const VIEW_ZONES = {
    front_angle: [
      ...
      { id:"wheels",        cx:45,  cy:73, label:"Wheels & Tires",           sub:"596kg CO₂e",            color:"#2ecc71" },
      { id:"brakes",        cx:32,  cy:73, label:"Brake System",             sub:"191kg CO₂e",            color:"#7f8c8d" },
      { id:"battery",       cx:60,  cy:71, label:"HV Battery Pack",          sub:"4.4t CO₂e",             color:"#e74c3c" },
