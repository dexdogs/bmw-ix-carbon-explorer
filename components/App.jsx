...
function CarView({ onZoneClick, selectedZone, hoveredZone: externalHover }) {
  ...
  const VIEW_ZONES = {
    ...
    back_angle: [
      { id:"cfrp_roof",     cx:53,  cy:37,   label:"CFRP Roof Panel",         sub:"5 parts · 1 PCRs",                     color:"#8e44ad" },
      ...
      { id:"electronics",   cx:22,  cy:46,   label:"Taillights & Electronics",sub:"1,800 parts · 7 PCRs",                      color:"#e67e22" },
      { id:"rear_motor",    cx:20,  cy:60,   label:"Rear Motor + Inverter",   sub:"20 parts · 3 PCRs",                     color:"#3498db" },
      { id:"wheels",        cx:47,  cy:78,   label:"Rear Wheels & Tires",     sub:"12 parts · 3 PCRs",                     color:"#2ecc71" },
      { id:"suspension",    cx:24,  cy:74,   label:"Suspension & Steering",   sub:"220 parts · 6 PCRs",                     color:"#2980b9" },
      { id:"battery",       cx:77,  cy:78,   label:"HV Battery Pack",         sub:"60 parts · 9 PCRs",                      color:"#e74c3c" },
      { id:"charging",      cx:56,  cy:57,   label:"Charging System",         sub:"5 parts · 2 PCRs",                      color:"#f39c12" },
      { id:"polymers_misc", cx:72,  cy:56,   label:"Side Panels & Polymers",  sub:"600 parts · 9 PCRs",                     color:"#9b59b6" },
      { id:"brakes",        cx:62,  cy:73,   label:"Brake System",            sub:"60 parts · 4 PCRs",                     color:"#7f8c8d" },
    ],
  };
