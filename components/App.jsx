...
const GLOSSARY = [
  ...
  { term: "dMRV", full: "Digital Monitoring, Reporting & Verification", def: "Use of digital sensors, continuous data streams, and cryptographic verification to replace manual, sampled emissions reporting. dMRV closes the gap between estimated and primary emissions data — the same gap this dataset makes visible." },
...
const INFO_SECTIONS = [
  { title: "About this dataset", content: "This is a Phase 1 carbon data layer for the BMW iX xDrive45 — a dual-motor electric SUV producing 313 kW (425 hp). BMW published a verified lifecycle footprint of 32.9 tonnes CO₂e on the EU electricity grid and 26.4 tonnes CO₂e on green electricity, per ISO 14040/44, verified by TÜV Rheinland. The cradle-to-gate (supply chain only) footprint is approximately 20.2 tonnes CO₂e. This dataset maps 80 Product Category Rules (PCRs) across 15 vehicle zones, covering approximately 3,000 estimated Product Carbon Footprints (PCFs) across ~30,000 parts." },
  { title: "The Catena-X kidney grille", content: "BMW and Covestro demonstrated the first fully verified automotive Product Carbon Footprint (PCF) for the iX kidney grille via the Catena-X data network — primary emissions data flowing from Covestro's polymer production through BMW's Landshut manufacturing plant, with tooling verified by Siemens. The grille weighs approximately 2 kg and contributes ~8 kg CO₂e. That is 1 verified PCF out of ~3,000 estimated ones, covering 1 part out of ~30,000. It is the only primary-data point in this entire dataset." },
  { title: "Data quality tiers", content: "Primary (Catena-X): facility-level, digitally verified data from named suppliers via the Catena-X network — currently only the kidney grille. Supplier EPD: third-party-verified Environmental Product Declarations from named suppliers. Industry Average: published sectoral emission factors (e.g. worldsteel, European Aluminium). Generic LCI: proxy emission factors from databases such as ecoinvent or GaBi. Estimate: engineering judgement with no supplier-specific data. The HV battery pack — the single largest carbon contributor at ~21.7% of supply chain emissions — is rated Generic LCI / Estimate." },
  { title: "Vehicle footprint facts", content: "The BMW iX xDrive45 weighs 2,510 kg kerb weight. The 111.5 kWh gross (105.2 kWh net) lithium-ion battery pack alone accounts for ~4,382 kg CO₂e in production — more than 21% of total supply chain emissions. The body structure (steel, aluminium, composites) contributes ~5,700 kg CO₂e across ~2,000 parts. Carbon fibre for the CFRP roof panel emits approximately 25 kg CO₂e per kg of fibre produced, making it one of the highest-intensity materials by weight in the vehicle. BMW sources battery cells from Samsung SDI, CATL, and Northvolt." },
];
  ...
  return(
    <div className="bmw-infopanel" style={{ position:"absolute", top:130, right:selectedZone?412:18, width:340, maxHeight:"calc(100vh - 160px)", overflowY:"auto", zIndex:25, background:"rgba(8,12,21,0.97)", border:"1px solid #00ff8833", borderRadius:12, padding:20, fontFamily:"'Space Grotesk', sans-serif" }}>
      ...
      <div style={{ marginTop:16, padding:"10px 12px", borderRadius:8, background:"rgba(0,255,136,0.04)", border:"1px solid #00ff8822" }}>
        <div style={{ fontSize:10, color:"#00ff88aa", lineHeight:1.6 }}>BMW Vehicle Footprint Report · TÜV Rheinland verified · ISO 14040/44 · Catena-X PCF Rulebook v2.0</div>
      </div>
    </div>
  );
}
